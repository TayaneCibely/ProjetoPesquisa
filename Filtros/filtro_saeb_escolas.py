...
df = pd.read_csv('TS_ESCOLA.csv', sep=',', encoding='ISO-8859-1')
...
df_pernambuco.to_csv('dados_pernambuco_saeb_escolas.csv', index=False, sep=';')
df_paraiba.to_csv('dados_paraiba_saeb_escolas.csv', index=False, sep=';')